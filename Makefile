ITCH_GAME_SLUG=gordon-et-gordon-mortelle-menace-trilogy
ITCH_USERNAME_SLUG=cevantime
...
web:
	...
	butler push ${WEB_EXPORT_FOLDER} ${ITCH_USERNAME_SLUG}/${ITCH_GAME_SLUG}:web
	rm -rf ${WEB_EXPORT_FOLDER}
...
linux:
	...
	butler push ${LINUX_EXPORT_FOLDER} ${ITCH_USERNAME_SLUG}/${ITCH_GAME_SLUG}:linux
	rm -rf ${LINUX_EXPORT_FOLDER}
...
windows:
	...
	butler push ${WINDOWS_EXPORT_FOLDER} ${ITCH_USERNAME_SLUG}/${ITCH_GAME_SLUG}:windows
	rm -rf ${WINDOWS_EXPORT_FOLDER}
